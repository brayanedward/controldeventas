                                    ...
                                    <table id="datatable" class="table table-striped mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-priority="3" id="tech-companies-1-col-2-clone">Apellidos</th>
                                                <th data-priority="1" id="tech-companies-1-col-3-clone">Edad</th>
                                                <th data-priority="1" id="tech-companies-1-col-3-clone">BONO POR HIJO</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td data-org-colspan="1" data-priority="1" data-columns="tech-companies-1-col-1"><?php echo strtoupper($rows['apellidop_cliente']); ?> <?php echo strtoupper($rows['apellidom_cliente']); ?></td>
                                                    <td data-org-colspan="1" data-priority="1" data-columns="tech-companies-1-col-1"><?php echo $rows['edad_actual']; ?> <b>año(s)</b> <?php echo $rows['meses_actual'];?><b> Mes(es)</b> <?php echo $rows['dias_actual']; ?> <b>día(s)</b></td>
                                                    ...
                                                    <td data-org-colspan="1" data-priority="1" data-columns="tech-companies-1-col-5">
                                                        ...
                                                        <span class="hint  hint--left iconPerfil" data-hint="Ver Información Cliente" attr-rut="<?php echo $rows['rut_cliente'] ?>">
                                                        ...
                                                        <span class="hint  hint--left" data-hint="Realizar Visita">
                                                            <button class="btn btn-icon waves-effect waves-light btn-success"  onclick="realizarVisita(<?php echo $rows['rut_cliente']?>)">
                                                                <i style="cursor: pointer;" class="mdi mdi-fingerprint  " id="iconVisita"></i>
                                                            </button>
                                                        </span>
                                                        <span class="hint  hint--left" data-hint="Historial de Visitas">
                                                            <button class="btn btn-icon waves-effect waves-light btn-info" onclick="historilVisitas(<?php echo $rows['rut_cliente']?>)">
                                                                <i style="cursor: pointer;" class="mdi mdi-history " id="iconHistorial"></i>
                                                            </button>
                                                        </span>

                                                        <span class="hint  hint--left" data-hint="Editar Cliente">
                                                            <a class="btn btn-icon waves-effect waves-light btn-primary" href="<?php echo $this->urledit . base64_encode($rows['rut_cliente']); ?>">
                                                                <i style="cursor: pointer;" class="mdi mdi-pen " id="iconHistorial"></i>

                                                        <span class="hint  hint--left" data-hint="Generar PDF">
                                                            <a href="<?php echo $this->generaPDF . $rows['rut_cliente']; ?>" target="_blank">
