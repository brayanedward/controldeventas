                    ...
                    <div class="container">
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            ...
                            <!--<li class="dropdown hidden-xs">
                                <a data-toggle="dropdown" class="dropdown-toggle menu-item waves-effect waves-light" href="#" aria-expanded="false">Español
...
<!--
                            ...
                            <li class="dropdown user-box">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right arrow-dropdown-menu arrow-menu-right user-list notify-list">
                                    <li>
                                        <h5>Hola, <?php echo base64_decode($_SESSION['nombreUsuario']) ?></h5>
                                    </li>
                                    <li><a href="view.php?c=usuario&a=edit2&id=<?php echo $_SESSION['rutUsuario'];?>"><i class="ti-user m-r-5"></i> Mi Perfil</a></li>
                                    <!-- <li><a href="javascript:void(0)"><i class="ti-settings m-r-5"></i> Settings</a></li>
                                    <li><a href="javascript:void(0)"><i class="ti-lock m-r-5"></i> Lock screen</a></li> -->
                                    <li><a href="./view.php?c=login&a=logout" ><i class="ti-power-off m-r-5"></i> Cerrar Sesión</a></li>
                                </ul>
                            </li>
                    ...
                    <div id="sidebar-menu">
                        <div class="user-details">
                            ...
                            <div class="text-center">
                                <img src="assets/images/users/avatar-1.png" alt="" class="thumb-md img-circle">
                            </div>
                            <div class="user-info">
                                <div>
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="view.php" class="waves-effect"><i class="mdi mdi-view-dashboard"></i><span> Inicio </span> </a>
                           </li>
                            ...
                            <!-- <li class="menu-title">Extra</li> -->
                             ...
                             <!-- <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-invert-colors"></i> <span>Mantenedores </span><span class="badge badge-danger pull-right">Nuevo</span></a>
                                <ul class="list-unstyled">
                                    <li><a href="./view.php?c=profesional">Profesionales</a></li>
                                    <li><a href="./view.php?c=usuario">Usuarios</a></li>
                                    <li><a href="./view.php?c=pacientes">Pacientes</a></li>
                                    <li><a href="./view.php?c=estado">Estados</a></li>
                                    <li><a href="./view.php?c=usuario">Establecimientos</a></li>
                                    <li><a href="./view.php?c=usuario">Agenda</a></li>
                                </ul>
                            </li> -->
                        </ul>
                    </div>
