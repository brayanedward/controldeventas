<?php
if (isset($_SESSION['rutUsuario'])) {} else {
...
<html>
    <head>
        ...
        <!-- App title -->
         ...
         <!-- Sweet Alert -->
         <link href="assets/plugins/bootstrap-sweetalert/sweet-alert.css" rel="stylesheet" type="text/css"><title> Ayelen SPA- Control de Ventas</title>
